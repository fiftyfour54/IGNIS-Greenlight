...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		...
		and Duel.IsPlayerCanSpecialSummonMonster(tp,id,0,SET_TISTINA,0,0,10,RACE_AQUA,ATTRIBUTE_LIGHT) end
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,id,0,SET_TISTINA,0,0,10,RACE_AQUA,ATTRIBUTE_LIGHT) then return end
