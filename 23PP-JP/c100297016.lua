...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(aux.FaceupFilter(Card.IsLevel,7),1,nil)
end
...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.SelectMatchingCard(tp,s.costfilter,tp,LOCATION_HAND+LOCATION_DECK,0,2,2,e:GetHandler())
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	--Can only Special Summon from the Extra Deck one
