...
function s.spfilter(c,e,tp)
	return c:IsRace(RACE_DINOSAUR|RACE_ROCK)
...
function s.sptg2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return ft>0 and #g>0
		and aux.SelectUnselectGroup(g,e,tp,1,math.min(ft,2),aux.dpcheck(Card.GetRace),0) end
