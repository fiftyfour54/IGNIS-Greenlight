...
function s.initial_effect(c)
	--Activate
	local e1=Fusion.CreateSummonEff({handler=c,fusfilter=aux.FilterBoolFunction(Card.IsSetCard,0x259),extrafil=s.extrafil,extraop=Fusion.BanishMaterial})
...
function s.extrafil(e,tp,mg)
	...
	local g=Duel.GetMatchingGroup(nil,tp,LOCATION_DECK+LOCATION_GRAVE,0,mg)
