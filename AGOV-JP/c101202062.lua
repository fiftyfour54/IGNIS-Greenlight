...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local sc=Duel.SelectMatchingCard(s.spfilter,tp,LOCATION_DECK,0,1,nil,e,tp,c:GetCode()):GetFirst()
...
function s.actlimit(e,re,tp)
	...
	return re:IsMonsterEffect() --monster effect
		...
		and (effcod&EVENT_SUMMON_SUCCESS>0 or effcod&EVENT_SPSUMMON_SUCCESS>0) --on summon trigger
end