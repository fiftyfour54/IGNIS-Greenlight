...
function s.costfilter(c)
	return c:IsMonster() and c:IsRace(RACE_INSECT) and c:IsAbleToRemoveAsCost()
end
function s.setfilter(c,e,tp)
	return c:IsFaceup() and c:IsRace(RACE_INSECT) and c:IsAttackAbove(3000)
end
function s.setcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(s.setfilter,tp,LOCATION_MZONE,0,1,nil) and Duel.GetTurnPlayer()==tp
end
