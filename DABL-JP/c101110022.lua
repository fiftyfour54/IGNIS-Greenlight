...
function s.thfilter(c)
	return (c:IsSetCard(0xc7) or c:IsSetCard(0xc8)) and not c:IsType(TYPE_PENDULUM) and c:IsAbleToHand()
end
...
function s.tdop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g<1 or Duel.SendtoDeck(g,nil,SEQ_DECKSHUFFLE,REASON_EFFECT)<1 then return end
...
function s.spfilter(c,e,tp)
	return (c:IsSetCard(0xc7) or c:IsSetCard(0xc8)) and not c:IsCode(id)
