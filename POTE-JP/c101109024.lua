...
function s.initial_effect(c)
	--Add 1 "Vendread" Spell/Trap to the hand if sent to the GY
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP) and not eg:IsContains(c) end
