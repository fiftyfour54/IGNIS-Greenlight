...
function s.acttg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetMatchingGroup(s.solfilter,tp,LOCATION_EXTRA,0,nil):GetClassCount(Card.GetCode)>2 end
...
function s.actop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(function(e,c) return c:IsSetCard(SET_SOLFACHORD) and c:IsType(TYPE_PENDULUM) end)
