...
function s.costfilter(c)
	return (c:IsCode(CARD_VISAS_STARFROST) or c:IsSetCard(SET_MANADOME)) and not c:IsPublic()
end
...
function s.cfilter(c)
	return c:IsFaceup() and c:GetAttack()==1500 and c:GetDefense()==2100 and not c:IsType(TYPE_TUNER)
end
