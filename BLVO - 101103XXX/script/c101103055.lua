...
function s.filter(c,e,tp)
	return c:IsSetCard(0x258) and c:IsType(TYPE_XYZ) and Duel.GetLocationCountFromEx(tp,tp,nil,c)>0 and
...
function s.catg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return and Duel.IsExistingTarget(Card.IsFaceup,tp,0,LOCATION_MZONE,1,nil) end
