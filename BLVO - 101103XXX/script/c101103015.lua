...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--An opponent's monster in same column as your "Security Force" monster loses 600 ATK
...
function s.filter(c,e,tp)
	return not c:IsCode(id) and c:IsSetCard(0x260) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
	--Activation legality
