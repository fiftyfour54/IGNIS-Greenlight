...
function s.filter(c,e,tp,zone)
	return c:IsSetCard(0x260) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP,tp,zone)
end
...
function s.seqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
							and Duel.IsExistingTarget(nil,tp,LOCATION_MZONE,0,1,nil,0x260) end
