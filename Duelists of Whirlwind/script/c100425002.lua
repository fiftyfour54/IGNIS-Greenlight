...
function s.exfilter(c,lv,code,e,tp)
	return c:IsSetCard(0x2016) and c:IsLevel(lv) and not c:IsCode(code) and Duel.GetLocationCountFromEx(tp,tp,nil,c)>0 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
