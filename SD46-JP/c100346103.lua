...
function s.lvtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and c:IsFaceup() and c:HasLevel() end
...
function s.lvop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) and g:GetFirst():IsLocation(LOCATION_GRAVE) then
		local dec=tc:IsLevelAbove(2)
		local value=Duel.SelectEffect(tp,
			{true,aux.Stringid(id,3)}, --increase level by 1
			{dec,aux.Stringid(id,4)}) --decrese level by 1
