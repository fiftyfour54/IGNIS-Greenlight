...
function s.cfilter(c,tp)
	return c:IsRace(RACE_REPTILE) and c:IsReason(REASON_DESTROY) and c:IsReason(REASON_BATTLE+REASON_EFFECT)
...
function s.mlcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return rp~=tp and c:IsReason(REASON_EFFECT) and c:IsPreviousLocation(LOCATION_FZONE) and c:IsPreviousControler(tp)
end
