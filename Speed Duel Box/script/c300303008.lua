...
function s.thcon(e,tp,ep,eg,ev,re,r,rp)
	return Duel.IsMainPhase() and Duel.GetTurnPlayer()==tp and Duel.GetFlagEffect(ep,id+1)==0
end
function s.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.thfilter,tp,LOCATION_DECK+LOCATION_GRAVE,0,2,nil,tp) end
