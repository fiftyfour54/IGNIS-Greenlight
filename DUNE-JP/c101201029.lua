...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local ct2=Duel.GetMatchingGroupCount(aux.FaceupFilter(Card.IsSummonLocation,LOCATION_EXTRA),tp,0,LOCATION_MZONE,nil)
	if ct2>0 and Duel.IsExistingMatchingCard(s.tgfilter,tp,LOCATION_EXTRA,0,1,nil) then
