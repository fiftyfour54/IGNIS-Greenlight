...
s.xyz_number=1000
function s.adcon(e)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_SPECIAL+id) and not Duel.IsTurnPlayer(e:GetHandlerPlayer())
end
function s.atcon(e)
...
function s.winop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetTurnPlayer()==1-tp and e:GetHandler():GetBattledGroupCount()==0 then
