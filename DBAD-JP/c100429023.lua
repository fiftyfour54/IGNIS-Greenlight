...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Increase ATK/DEF of "Purery" Xyz monsters with this card as material
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local property=EFFECT_FLAG_CLIENT_HINT+(tc:IsPosition(POS_FACEDOWN) and EFFECT_FLAG_SET_AVAILABLE or 0)
