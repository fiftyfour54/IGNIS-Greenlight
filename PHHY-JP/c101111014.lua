...
function s.eqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SetOperationInfo(0,CATEGORY_EQUIP,c,1,tp,LOCATION_HAND|LOCATION_GRAVE)
...
function s.valuecond()
	return Duel.IsBattlePhase() or Duel.GetCurrentPhase()==PHASE_MAIN2
end