...
function s.gytg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return ct>0 and aux.SelectUnselectGroup(g,e,tp,1,ct,s.rescon,0) end
	local rg=aux.SelectUnselectGroup(g,e,tp,1,ct,s.rescon,1,tp,HINTMSG_REMOVE,s.rescon,nil,false)
