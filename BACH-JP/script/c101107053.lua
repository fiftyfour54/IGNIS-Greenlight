...
function s.discon(e,tp,eg,ep,ev,re,r,rp)
	...
	return rp==1-tp and re:IsActiveType(TYPE_MONSTER) and Duel.IsChainDisablable(ev) and Duel.IsExistingMatchingCard(s.filter,tp,LOCATION_MZONE,0,1,nil) and (rc:IsAttack(0) or rc:IsDefense(0))
end
...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	local a,at=Duel.GetAttacker(),Duel.GetAttackTarget()
	local g=Group.FromCards(a,at):Filter(Card.IsControler,nil,1-tp)
