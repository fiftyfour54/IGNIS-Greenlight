...
function s.incon(e)
	return Duel.IsExistingMatchingCard(s.indfilter,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil,e:GetHandler()) 
end
--destroy all
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local rg=Duel.SelectMatchingCard(tp,s.rmfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil)
