...
function s.cfilter(c)
	return c:IsFaceup() and c:IsCode(10000000) and c:GetOriginalAttribute()==ATTRIBUTE_DEVINE 
end
function s.check(sg,tp)
	return Duel.IsExistingMatchingCard(s.cfilter,tp,LOCATION_MZONE,0,1,sg)
end
