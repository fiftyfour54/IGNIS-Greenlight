...
function s.initial_effect(c)
	c:EnableReviveLimit()
	Fusion.AddProcMixRep(c,true,true,s.mfilter,1,99,aux.FilterBoolFunctionEx(Card.IsRace,RACE_WARRIOR))
	--spsummon condition
...
function s.desop(e,tp,eg,ep,ev,re,r,rp)
	local bc=e:GetHandler():GetBattleTarget()
	if bc and bc:IsRelateToBattle() and bc:IsFaceup() and Duel.Destroy(bc,REASON_EFFECT)~=0 then
