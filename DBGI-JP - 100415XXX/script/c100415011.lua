...
function s.initial_effect(c)
	--Activate
	local e1=Fusion.CreateSummonEff({handler=c,matfilter=s.matfilter,extrafil=s.fextra})
...
function s.fextra(e,tp,mg)
	return Duel.GetMatchingGroup(s.matfilter,tp,LOCATION_ONFIELD+LOCATION_HAND,0,nil),s.checkmat
end
