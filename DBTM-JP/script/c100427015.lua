...
function s.initial_effect(c)
	...
	e4:SetValue(function(e,c) return c~=e:GetHandler() and c:IsRace(RACE_FIEND) end)
	c:RegisterEffect(e4)
end
...
function s.setfilter(c)
	return c:GetType()==TYPE_TRAP and c:IsSSetable() and not c:IsForbidden() and c:GetActivateEffect():GetCode()==EVENT_ATTACK_ANNOUNCE
end
